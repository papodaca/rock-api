...
/***/ function(module, exports, __webpack_require__) {
	...
	var _middleware = __webpack_require__(73);

	var _middleware2 = _interopRequireDefault(_middleware);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var handler = exports.handler = function handler(event, context, cb) {
	  context.succeed({
	    event: (0, _keys2.default)(event),
	    context: (0, _keys2.default)(context),
	    cb: typeof cb === "undefined" ? "undefined" : (0, _typeof3.default)(cb)
	  });
	};
